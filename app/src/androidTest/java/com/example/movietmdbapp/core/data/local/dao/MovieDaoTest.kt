...
class MovieDaoTest {
    ...
    @Test
    fun test_getMovie_should_return_current_movie_by_id() = runTest {
        // Given
    ...
    fun test_insertMovie_should_insert_a_movie_successfully() = runTest {
        ...
        // Then
        assertThat(movies[0].movieId).isEqualTo(movieEntity.movieId)
    }
    ...
    fun test_isFavorite_should_return_favorite_movie_when_movie_is_marked_as_favorite() = runTest {
        ...
        val movieId = 5321
        val favoriteMovie =
            MovieEntity(movieId = movieId, title = "Homem de Ferro 1", imageUrl = "Url1")
    ...
    fun test_isFavorite_should_return_null_when_movie_is_not_marked_as_favorite() = runTest {
        ...
        val result = movieDao.isFavorite(movie)
